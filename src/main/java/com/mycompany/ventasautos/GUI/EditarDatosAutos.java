...
public class EditarDatosAutos extends javax.swing.JFrame {

    Controladora control = new Controladora();
    Auto auto = new Auto();
    int id_auto;
    
    public EditarDatosAutos(int id_auto) {
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        control.modificarAuto(auto,modelo,marca,motor,color,patente,puerta);
    ...
    private void btnAtrasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAtrasActionPerformed
        VerDatosAutos pantallaDatos = new VerDatosAutos();
    ...
    private void cargarDatos(int id_auto){
        this.auto = control.traerAuto(id_auto);
        ...
        String  puertasStr = String.valueOf(this.auto.getCantidadPuertas());
        txtPuerta.setText(puertasStr);
